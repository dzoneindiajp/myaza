        ...
        <div class="login-logo">
            <div class="login-logo">
                <a href="<?php echo e(route('admin.home')); ?>">
                  ...
                  ?>
                    <img src="<?php echo e(asset("file/$store->logo")); ?>" alt="<?php echo e(trans('panel.site_title')); ?>" style="width: 200px;" />
                </a>
            </div>
        </div>
        <div class="card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>