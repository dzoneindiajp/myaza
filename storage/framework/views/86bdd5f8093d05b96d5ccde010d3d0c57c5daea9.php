...
<?php $__env->startSection('content'); ?>
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-primary" href="<?php echo e(route('admin.video-add.create')); ?>">
                    Add Video
                </a>
            </div>
        </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(function() {
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('slider_delete')): ?>
                ...
                url: "<?php echo e(route('admin.videoAdd.massDestroy')); ?>",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "<?php echo e(route('admin.video-add.index')); ?>",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
            ...
            //     else{ status = 0;}
                ...
                // $.ajax({
                //     type:'POST',
                //     url:"<?php echo e(url('supersecure/videoadd/status/update')); ?>",
    ...
    <script>
        ...
        $(document).on('click','#is-attribute-chk', function(){
                ...
                $.ajax({
                    type:'POST',
                    url:"<?php echo e(route('admin.videoAdd.status.update')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/admin/videoAdd/index.blade.php ENDPATH**/ ?>