...
$parents = \App\Models\Category::where('parent_id',0)->where('is_menu',1)->where('status',1)->get();  
$htext = \App\Models\Htext::whereStatus('1')->latest()->limit(4)->get();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script>
 ...
 <header class="header-section">
                ...
                <div class="header-top-left col-lg-6 col-md-6 col-sm-12 col-12">
                  <div class="header-announcement">
                    <div class="header-announcement-carousel">
                      ...
                      <marquee direction="left"><p class="announcement-item"><a href="#"><?php echo $t->text; ?></a></p></marquee>
                      <?php } ?>
                    </div>
                  </div>
                </div>
          ...
          <div class="container-custom">
            <div class="header-row">
              <div class="header-logo">
                <a class="logo-link" href="<?php echo e(url('/')); ?>"><img class="logo" src="<?php echo e(asset('file/'.$sizecount->logo)); ?>" alt="logo"></a>
              </div>
              <div class="header-search">
                <div class="searchForm">
                  <form action="" method="get">
                    <input type="text" name="s" class="search-input" placeholder="Search Products">
                    <button class="btn btn-primary searchicon" id="searchbutton" type="button"><i class="fa fa-search"></i></button>
                  </form>
                </div>
              </div>
              <div class="header-shop-menu">
                <ul class="header-shop-link">
                  ...
                  <li class="acoount-icon">
                    ...
                    <ul class="login_user">
                  <li class="login_user_title"><a href="#">Hello Dzone India Jaipur <span></span></a></li>
                  ...
                  <li class="cart-menu dropdown">
                    <a href="<?php echo e(url('cart')); ?>" title="View your shopping cart" class="cart-contents">
                      ...
                      <div class="widget-shopping-cart">
                        ...
                        <span class="sidebar-cart-items"></span>
                          <p class="mini-cart-buttons">
                            ...
                            <a href="<?php echo e(route('checkout')); ?>" class="button checkout">Checkout</a>
                          </p>
                        </div>
                      </div>
                    </div>
                                        ...
                                        <div class="mega-submenu-column">
                                          <ul class="mega-submenu-item">
                                            <?php foreach($child->get() as $k=>$chi){ ?>
                                              <?php if($k>0 && $k%8==0){ ?>
                                                </ul></div><div class="mega-submenu-column"><ul class="mega-submenu-item">
                                              <?php } ?>
                                              <li><a href="<?php echo url('/'.$chi->slug) ;?>"><?php echo $chi->name; ?></a></li>
                                            <?php } ?>
                                          </ul>
                                        </div>
                                  </div>
                                  <div class="mega-submenu-img">
                                      <img src="https://myazatrendz.com/frontend-view/images/megamenu_img.jpg" alt="megamenu_img">
                                  </div>
                                </div>
                            </div>
                          </div>
    ...
    </header><?php /**PATH /home/myazatrendz/public_html/resources/views/frontend-view/includes/header.blade.php ENDPATH**/ ?>