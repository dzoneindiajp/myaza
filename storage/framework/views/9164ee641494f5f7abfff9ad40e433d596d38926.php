                                ...
                                <div class="img-thumbnail thumbnail-imges  ">
                                    <input type="checkbox" id="myCheckbox<?php echo e($image->id); ?>" data-id="<?php echo e($image->id); ?>"/>
                                      <label for="myCheckbox<?php echo e($image->id); ?>" id="mychklabel">
                                        <img class="box-image px-2 py-2" image_id="" src="<?php echo e(asset("file")); ?>/<?php echo e($image->name); ?>" alt="..." >
                                    </label>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/admin/media/index.blade.php ENDPATH**/ ?>