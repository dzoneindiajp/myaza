                  ...
                  <div class="page-banner-wrap">
                      <div role="navigation" aria-label="Breadcrumbs" class="breadcrumbs">
                          <ul class="breadcrumb-items">
                              ...
                              <li class="breadcrumb-item trail-begin"><a href="<?php echo e(url('/')); ?>/<?php echo e($info['category_slug']); ?>" rel="home"><span
                                          itemprop="name"><?php echo $info['category'] ;?></span></a></li>
                              <li class="breadcrumb-item trail-begin"><a href="<?php echo e(url('/')); ?>/<?php echo e($info['sub_category_slug']); ?>" rel="home"><span
                                          itemprop="name"><?php echo $info['sub_category'] ;?></span></a></li>
                              <?php if($info['child_category']!=""){ ?>
                                <li class="breadcrumb-item trail-begin"><a href="<?php echo e(url('/')); ?>/<?php echo e($info['child_category_slug']); ?>" rel="home"><span
                                  ...
                                  <div class="summary product-summary">
                                      ...
                                      <div class="product-price price">
                                        ...
                                        <?php if($mrp_price>$sales_price): ?>
                                            ...
                                            <span class="sale-badge" style="margin-left:3px;color:red"><?php echo e(round((($mrp_price-$sales_price)/$mrp_price)*100,2)); ?>% Off</span>
                                        <?php endif; ?>
                                      </div>
                                      <div class="product-meta">
                                          <span class="product-meta-code"><strong>SKU Code : </strong> <span class="sku"><?php echo $info['sku']; ?></span></span>
                                          <!--<span class="product-meta-category"><strong>Categories : </strong> <a href="<?php echo e(url('/')); ?>/<?php echo e($info['category_slug']); ?>"><?php //echo $info['category'] ;?></a>, <a href="<?php echo e(url('/')); ?>/<?php echo e($info['sub_category_slug']); ?>"><?php //echo $info['sub_category'] ;?></a></span>-->                                             
                                      </div>
                                      ...
                                      <form class="variations-form addcart" action="#" method="post">
                                        <input type="hidden" name="_token" id="_token" value="<?php echo e(csrf_token()); ?>">
                                              ...
                                              <input type="hidden" name="variation_id" id="variation_id" value="<?php echo $variatinid ; ?>">
                                                <input type="hidden" name="product_id" id="product_id" value="<?php echo $product->id ; ?>">
                                                  <table class="variations size_table" cellspacing="0">
                                                  <tbody>
                                                      <tr>
                                                          <td class="label"><label for="pa_color">Sizes</label></td>
                                                          <td class="value">            
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td class="value">            
                                                              ...
                                                              <?php foreach($pcolors as $col){ if(is_object($col)){ ?>
                                                                ...
                                                                <input onchange="bringvarsizes()" <?php echo ($fcolor == $col->id)?'checked':''; ?> id="color_<?php echo $col->name ; ?>" value="<?php echo $col->id ; ?>" type="radio" name="pa_color">
                                                                <label  data-toggle="tooltip" for="color_<?php echo $col->name ; ?>" title="<?php echo $col->name ; ?>"><span style="background-color: <?php echo $col->value ; ?>;"></span></label>
                                                                </li>
                                                                <?php }} ?>
                                                              </ul>
                                                          </td>
                                              ...
                                              <div class="wishlist-quantity-button">
                                                  ...
                                                  <div class="single-wishlist-btn">
                                                      <a href="javascript:void(0)" rel="nofollow" onclick="doAddToWishlist($(this))" data-product-id="<?php echo $product->id ; ?>" class="add_to_wishlist single_add_to_wishlist" title="Add to Wishlist">
                                               ...
                                               <div class="mb-5">
                                                    <span class="delivery-address">
                                                      ...
                                                      <span class="boldtxt"><i class="fas fa-map-marker-alt theme-color"></i>
                                                      <input class="form-control-1" type="text" placeholder="Enter Your Pincode" id="pincode-input">
                                                      <button class="btn-check" type="button" id="pincode-check">Check</button>
                                                      </span> 
                                                   </span>
                                                   <!--<span class="delivery-address ">
                                                  ...
                                                  <div class="pincode_message">
                                                      <div class="box-border text-danger" style="display:none" id="pincode-error"> <i class="fa fa-times" aria-hidden="true"></i> Service Not available in youe area Pin-code.</div>
                                                      <div class="box-border text-success" style="display:none" id="pincode-success"><i class="fa fa-map-marker" aria-hidden="true"></i> Delivery available in your area</div>
                                                      <div class="box-border"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i> Delivered Within 4-7 Working Days</div>
                                              ...
                                              <div class="product-summary-button">
                                                <input type="button" name="add" class="add_to_cart_button button" id="grouped-add-to-cart" value="Add to Cart">
                                                <button type="button" class="buy_now_button btn btn-outline-primary buy-now">Buy Now</button>
                                                <button style="display:none" type="button" data-toggle="modal" data-target="#myModal2" id="trigger_model"></button>
                                              </div>
                                      ...
                                      <div class="review-form-wrapper">
                                          ...
                                          <form action="" method="post" id="review_from" class="comment-form">
                                            ...
                                            <div class="form-submit">
                                                <input name="button" id="review_submit" type="button" class="btn btn-primary submit" value="Submit">
                                            </div>
                                        </form>
                                      </div>
                                  </div>
                                  ...
                                  <div class="product-wrap">
                                      <div class="product-image">
                                          ...
                                          <div class="product-action">
                                              ...
                                              <?php //echo $trend['variation_id']."_".$trend['id']; ?><?php echo ($trend['wishlist'])?'<i class="fas fa-heart"></i>':'<i class="far fa-heart"></i>'; ?>
                                              </a>
                                              <a href="<?php echo e(url('/')); ?>/<?php echo e($trend['slug']); ?>" class="add-to-cart ajax-spin-cart" data-toggle="tooltip" data-placement="top" title="Add to cart">
                                                  <span class="cart-title"><i class="fa fa-shopping-bag"></i></span>
                                              </a>
                                              <a href="<?php echo e(url('/')); ?>/<?php echo e($trend['slug']); ?>" class="quick-view" data-toggle="tooltip" data-placement="top" title="Quickview">
                                                  <i class="fa fa-eye"></i>
                                              </a>
                                          </div>
                                      </div>
                                      <div class="product-content">
                                          <h3 class="product-title">
                                              <a href="<?php echo e(url('/')); ?>/<?php echo e($trend['slug']); ?>"><?php echo $trend['name'] ;?></a>
                                          </h3>
...
function checkdelivery(v) {
    ...
    $('#review_submit').on('click',function(b){
        ...
        $('#cover-spin').show(0);
        $.post("<?php echo e(url('product/review')); ?>",$('#review_from').serialize(),function(v){
             $('#cover-spin').hide(0);
             if(v.success == false){
                 notifyme('error',v.message);
             }else{
        ...
        $.post("<?php echo e(url('products/images/get')); ?>",$('.variations-form').serialize(),function(v){
            ...
            if(v.images.length > 0 ) {
                ...
                $.each( v.images ,function (p,val) {
                    ...
                    if(p == 0){
                        acLass = 'active';
                        defaut = "<img class='xzoom' id='xzoom-default' src='"+ '<?php echo e(asset('file')); ?>/'+val.file_name +"' xoriginal='"+ '<?php echo e(asset('file')); ?>/'+val.file_name +"' />";
                    ...
                    mainimg +="<a class='"+acLass+"' href='"+ '<?php echo e(asset('file')); ?>/'+val.file_name +"'><img class='xzoom-gallery' width='80' src='"+ '<?php echo e(asset('file')); ?>/'+val.file_name +"' title='The description goes here'></a>";
                });
                $('.xzoom-container').html('<div class="xzoom-bigimg">'+defaut+'</div><div class="xzoom-thumbs">'+mainimg+'</div>');
...
<?php echo $__env->make('frontend-view.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/store/products/detail.blade.php ENDPATH**/ ?>