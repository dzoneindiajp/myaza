                                                    ...
                                                    <?php if($catid !== 0): ?>
                                                        <?php if(in_array($scolor->id, $match->colors) && $match->is_color === 1): ?>
                                                            <li class="active">
                                                                ...
                                                                <span data-colorhex="<?php echo e($scolor->value); ?>"
                                                                    class="colour-label colour-colorDisplay"
                                                                    style="background-color: <?php echo e($scolor->value); ?>;"></span>
                                                                <label for="color-<?php echo e($scolor->id); ?>"
                                                                    style="cursor:pointer"><?php echo e($scolor->name); ?>
                                                            ...
                                                            <?php if($value->value != ''): ?>
                                                                <li>
                                                                    <label class="container_category">
                                                                        <input class="filter"
                                                                            id="attribute-<?php echo e($daatr->id); ?>"
                                                                            data-name="<?php echo e($daatr->id); ?>"
                                                                            data-id="<?php echo e($value->id); ?>"
                                                                            type="checkbox"> <?php echo e($value->value); ?>
                                                    ...
                                                    <?php if($attr->attribute_values): ?>
                                                        <?php $__currentLoopData = $attr->attribute_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <label class="container_category">
                                                                    <input class="filter"
                                                                        id="attribute-<?php echo e($attr->id); ?>"
                                                                        data-name="<?php echo e($attr->id); ?>"
                                                                        data-id="<?php echo e($value->id); ?>" type="checkbox">
...
<?php /**PATH D:\xampp\htdocs\myaza\resources\views/store/search.blade.php ENDPATH**/ ?>