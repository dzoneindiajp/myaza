          ...
          <div class="row">
            <div class="sidebar-section col-md-3 col-sm-12 col-12">              
              <ul class="sidebar-account-menu">
                <li ><a href="<?php echo e(route('user.dashboard')); ?>"> <i class="fas fa-user"></i>My Account</a></li>
                <li><a href="<?php echo e(route('user.profile')); ?>"> <i class="fas fa-user"></i>My Profile</a></li>
                <!-- <li><a href="<?php echo e(route('user.orders')); ?>"> <i class="fas fa-address-book"></i>My Address</a></li> -->
                <li class="active"><a href="<?php echo e(route('user.orders')); ?>"> <i class="fas fa-shopping-basket"></i>My Orders</a></li>
                <li><a href="<?php echo e(route('user.wishlist')); ?>"> <i class="far fa-heart"></i>My Wishlist</a></li>            
                      ...
                      <div class="order-table">                       
                        <div class="tabel-row">
                          ...
                          <div class="table-cell order-img"><a href="javascript:void(0)">
                              <img src="<?php echo e(asset('file')); ?>/<?php echo e($images); ?>" width="75" height="205"></a>
                          </div>
                          <div class="table-cell">
                            ...
                            <?php if($ritems>0){ ?>
                              <p class="order-moreitem"><a href="<?php echo e(url('account/orders/detail')); ?>/<?php echo $od->id ; ?>">+<?php echo $ritems; ?>More Item</a></p>
                            <?php } ?>
                            <?php if($od->status == 0){?>
                          ...
                          <div class="table-cell order-btn">
                            <p class="order-view">
                              <a href="<?php echo e(url('account/orders/detail')); ?>/<?php echo $od->id ; ?>"><i class="far fa-eye"></i>View Order</a>
                            </p> 
                            <?php if($od->status === 0 || $od->status === 1 || $od->status === 2 ): ?>
                            <p class="order-view mt-2">
                            <a href="javascript:void(0)" class="cancel-btn btn btn-danger text-light" data-id="<?php echo e($od->id); ?>">
                                Cancel & Refund
                            </a>
                            </p>
                            <?php endif; ?>                          
...
<?php /**PATH /home/myazatrendz/public_html/resources/views/store/orders/index.blade.php ENDPATH**/ ?>