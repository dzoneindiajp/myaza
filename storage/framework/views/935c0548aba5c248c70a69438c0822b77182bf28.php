...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" id="product-editform" action="<?php echo e(route('admin.products.update',$product->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-3">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"
                                            type="text" name="name" id="name" value="<?php echo e(old('name', $product->name)); ?>" required>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('sku_code') ? 'is-invalid' : ''); ?>"
                                            type="text" name="sku_code" id="sku_code" value="<?php echo e(old('sku_code', $product->sku_code)); ?>"
                                            required >
                                        <?php if($errors->has('sku_code')): ?>
                                            <span class="text-danger"><?php echo e($errors->first('sku_code')); ?></span>
                                        <?php endif; ?>
                                        <span
                                            class="help-block"><?php echo e(trans('cruds.product.fields.sku_code_helper')); ?></span>
                                    </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('hsn_code') ? 'is-invalid' : ''); ?>"
                                            type="text" name="hsn_code" id="hsn_code" value="<?php echo e(old('hsn_code', $product->hsn_code)); ?>">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('tax_rate') ? 'is-invalid' : ''); ?>"
                                            type="number" name="tax_rate" id="tax_rate" value="<?php echo e(old('tax_rate', $product->tax_rate)); ?>"
                                            step="0.01">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('discount') ? 'is-invalid' : ''); ?>"
                                            type="number" name="discount" id="discount" value="<?php echo e(old('discount', $product->discount)); ?>"
                                            step="0.01">
                                    ...
                                    <div class="col-3">
                                        <div
                                            class="icheck-primary <?php echo e($errors->has('is_featured') ? 'is-invalid' : ''); ?>">
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <select class="form-control <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>"
                                            ...
                                            <option value disabled <?php echo e(old('status', $product->status) === null ? 'selected' : ''); ?>>
                                                <?php echo e(trans('global.pleaseSelect')); ?>
                                    ...
                                    <?php */ ?>
                                     <div class="form-group col-6">
                                        ...
                                        <textarea
                                            class="form-control desc <?php echo e($errors->has('care_and_disclaimer') ? 'is-invalid' : ''); ?>"
                                            name="care" id="editor"><?php echo old('care_and_disclaimer', $product->care); ?></textarea>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea
                                            class="form-control editor-details <?php echo e($errors->has('details') ? 'is-invalid' : ''); ?>"
                                            name="details" id="detail" required><?php echo old('details',$product->details); ?></textarea>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <textarea
                                            ...
                                            name="description" id="editor" required><?php echo old('description', $product->description); ?></textarea>
...
<?php echo $__env->make('admin.mediascript.multiple_next', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   ...
   var row_error = false;
        ...
        $(document).ready(function(){
            ...
            $.post("<?php echo e(url('backoffice/product/getpartials')); ?>",{'id':<?php echo e($product->id ?? 0); ?>},function(n){
                $('.ajax-content').html(n);
...
<script>
       ...
       if( newloaded["<?php echo e($value['product_color_id']); ?>"] === undefined )
        ...
        newloaded["<?php echo e($value['product_color_id']); ?>"].push({id: "<?php echo e($value['id']); ?>", src: `<?php echo e(asset('/storage/product').'/'.$value['file_name']); ?>`})
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>