                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <img src="<?php echo e(asset("file/$setting->favicon")); ?>" style="width : 50px;margin-top : 20px;"/>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <img src="<?php echo e(asset("file/$setting->logo")); ?>" style="width : 100px;margin-top : 20px;"/>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <img src="<?php echo e(asset("file/$setting->trans_logo")); ?>" style="width : 100px;margin-top : 20px;"/>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/admin/setting/edit.blade.php ENDPATH**/ ?>