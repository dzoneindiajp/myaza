                          ...
                          <table class="shop-table" cellspacing="0">
                            <tbody>
                              <tr class="cart-subtotal">
                                <th>Subtotal</th>
                                <td data-title="Subtotal"> <span class="price subtotal-all">₹<?php echo $total ; ?></span> </td>
                              </tr>
                              ...
                              <tr class="tax-totals tax">
                                <th>Tax</th>
                                <td data-title="Tax" id="total_tax">₹<?php echo $tax ; ?></td>
                              </tr>
...
<?php echo $__env->make('frontend-view.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/store/cart/index.blade.php ENDPATH**/ ?>