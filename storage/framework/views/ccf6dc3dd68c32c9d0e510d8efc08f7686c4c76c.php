                                             ...
                                             <form method="POST" action="" id="addressform">
                                                ...
                                                <div class="shipping-fields-wrapper row">
                                                   ...
                                                   <div class="form-group text-right col-sm-12 col-12">
                                                      <button type="button" disabled id="save-address" class="btn btn-primary">Submit</button>
                                                   </div>
                                                </div>
                                             </form>
                                          </div>
...
<?php /**PATH /home/myazatrendz/public_html/resources/views/store/checkout/index.blade.php ENDPATH**/ ?>