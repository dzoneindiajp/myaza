                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <?php endif; ?>
                                        <span
                                            class="help-block" ><?php echo e(trans('cruds.product.fields.sku_code_helper')); ?>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('hsn_code') ? 'is-invalid' : ''); ?>"
                                            type="text" name="hsn_code" id="hsn_code" value="<?php echo e(old('hsn_code', '')); ?>">
                                    ...
                                    <div class="form-group col-6">
                                         ...
                                         <input class="form-control <?php echo e($errors->has('size_chart') ? 'is-invalid' : ''); ?>"
                                           type="file" name="size_chart" id="size_chart" value="<?php echo e(old('size_chart', '')); ?>"> 
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('tax_rate') ? 'is-invalid' : ''); ?>"
                                            type="number" name="tax_rate" id="tax_rate" value="<?php echo e(old('tax_rate', '')); ?>"
                                            step="0.01">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input class="form-control <?php echo e($errors->has('discount') ? 'is-invalid' : ''); ?>"
                                            type="number" name="discount" id="discount" value="<?php echo e(old('discount', '')); ?>"
                                            step="0.01">
                                    ...
                                    <div class="col-3">
                                        <div class="icheck-primary <?php echo e($errors->has('is_sho_by_look') ? 'is-invalid' : ''); ?>">
                                            <input type="checkbox" name="is_sho_by_look" id="is_sho_by_look" value="1"
                                                <?php echo e(old('is_sho_by_look', 0) == 1 ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea
                                            ...
                                            name="care" id="editor"><?php echo old('care_and_disclaimer'); ?></textarea>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea
                                            class="form-control detail editor-details <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>"
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea
                                            class="form-control desc <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>"
                                            name="description" id="editor" required><?php echo old('description'); ?></textarea>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <textarea
                                            ...
                                            name="need_help" id="need_help" required><?php echo old('need_help'); ?></textarea>
                                    ...
                                    <!--<div class="form-group col-6">
                                        ...
                                        <textarea
                                            class="form-control desc <?php echo e($errors->has('return') ? 'is-invalid' : ''); ?>"
                                            name="return" id="editor" required><?php echo old('return'); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\myaza\resources\views/admin/products/create.blade.php ENDPATH**/ ?>