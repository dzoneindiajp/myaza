...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" class="form-row" action="<?php echo e(route("admin.cms-pages.store")); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group col-3">
              ...
              <input class="form-control <?php echo e($errors->has('sub_title') ? 'is-invalid' : ''); ?>" type="text" name="sub_title" id="sub_title" value="<?php echo e(old('sub_title', '')); ?>" required>
            ...
            <div class="form-group col-3">
                ...
                <input class="form-control <?php echo e($errors->has('image') ? 'is-invalid' : ''); ?>" type="text" name="image" id="image" value="<?php echo e(old('image', '')); ?>">
            ...
            <div class="form-group col-3">
              ...
              <input class="form-control <?php echo e($errors->has('tags') ? 'is-invalid' : ''); ?>" type="text" name="tags" id="tags" value="<?php echo e(old('tags', '')); ?>">
          ...
          <div class="form-group col-3">
            ...
            <div class="form-group col-6">
                ...
                <textarea class="form-control <?php echo e($errors->has('meta_keyword') ? 'is-invalid' : ''); ?>" name="meta_keyword" id="meta_keyword"><?php echo e(old('meta_keyword')); ?></textarea>
            ...
            <div class="form-group col-12">
                <label for="ckeditor"><?php echo e(trans('cruds.cmsPage.fields.description')); ?></label>
                <textarea class="form-control ckeditor <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>" name="description" id="ckeditor"><?php echo old('description'); ?></textarea>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/admin/cmsPages/create.blade.php ENDPATH**/ ?>