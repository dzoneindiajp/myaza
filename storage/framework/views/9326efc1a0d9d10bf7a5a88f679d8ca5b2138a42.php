                  ...
                  <div class="panel-body">
                     <div class="row align-items-center">
                        <div class="col-sm-6 top-left">
                           <img src="<?php echo e(asset('file')); ?>/<?php echo e($setting->logo); ?>" >
                        </div>
                        <div class="col-sm-6 top-right text-right">
                           <h3>Tax Invoice</h3>
                           <span>Invoice No.-INV<?php echo e($single->order_id); ?></span>
                        </div>
                     </div>
                     <hr>
                     <div class="row justify-content-between">
                        ...
                        <div class="col-sm-4 text-right">
                        	...
                        	<p><strong>Date :</strong><?php echo date('d-m-Y', strtotime($single->created_at)); ?></p>
                        	<p><strong>Total Amount :</strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span><?php echo e($grandTotal+$shipp); ?></p>
                        </div>
                     </div>
                     <div class="row table-row">
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td><?php echo e($y+1); ?></td>
                              <td><?php echo e($product->name); ?></td>
                              <td><?php echo e($product->sku); ?></td>
                              <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span><?php echo e($item->attributes->sale_price); ?></td>     
                              <td><?php echo e($item->quantity); ?></td>
                              <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span><?php echo e(($item->quantity*$item->attributes->sale_price)-($rt*$item->quantity)); ?></td>                        
                              <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span><?php echo e($rt*$item->quantity); ?></td>    
                              <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span><?php echo e($item->quantity*$item->attributes->sale_price); ?></td>     
                            </tr>
                            <?php } ?>
                           </tbody>
                        </table>
                     ...
                     <div class="row justify-content-between">
                        <div class="col-md-7">
                           <p><strong>Total Amount (in words) : INR <?php echo e(getIndianCurrency($grandTotal)); ?></strong></p>
                           <h3>Declaration</h3>
                        ...
                        <div class="col-md-5 text-right mt-3">
                           ...
                           <!--<p class="lead marginbottom"><img src="images/signature_img.jpg" alt=""> </p>
...
</html><?php /**PATH D:\xampp\htdocs\myazatrendz\resources\views/emails/invoice.blade.php ENDPATH**/ ?>