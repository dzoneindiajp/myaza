...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="#" class="brand-link p-2 text-center">
        <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="<?php echo e(trans('panel.site_title')); ?>"
            style="height: 40px;" />
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-compact text-sm" data-widget="treeview"
                ...
                <li class="nav-item has-treeview <?php echo e(in_array($curr_route2, $reports_routes) ? 'menu-open' : ''); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e($curr_route2 == 'users' ? 'active' : ''); ?>"
                                href="<?php echo e(route('admin.reports.users')); ?>">
                                <i class="fa-fw nav-icon fas fa-archive"></i>
                                <p>
                                    Users Report
                                </p>
...
<?php /**PATH D:\xampp\htdocs\myaza\resources\views/partials/menu.blade.php ENDPATH**/ ?>