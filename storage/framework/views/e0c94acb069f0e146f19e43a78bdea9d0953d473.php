        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <a href="<?php echo e(url('backoffice/reports/users')); ?>" class="btn btn-danger clear_btn">Clear</a>
                </div>
            </div><br>
    ...
    <script>
        ...
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                ajax: {
                    url: "<?php echo e(route('admin.reports.users')); ?>",
                    data: function (d) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\myaza\resources\views/admin/reports/users.blade.php ENDPATH**/ ?>