                                ...
                                <button class="filter-dropdown-title" data-toggle="dropdown" aria-haspopup="true"
                                    ...
                                    <?php if(in_array($scolor->id, $match->colors) && $match->is_color === 1): ?>
                                        <li class="active">
                                            ...
                                            <span>(
                                                <?php
                                                    $data = DB::table('product_variations')->join('products','products.id','product_variations.product_id')->where('product_variations.color_id', $scolor->id)->where('products.status', 1);
...
<?php echo $__env->make('frontend-view.includes.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/store/search.blade.php ENDPATH**/ ?>