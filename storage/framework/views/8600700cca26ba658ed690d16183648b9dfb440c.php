                        ...
                        <div class="img-thumbnail thumbnail-imgess">
                            <input type="checkbox" id="myCheckbox${data.id}" data-id="${data.id}" data-img="${data.name}"/>
                              <label for="myCheckbox${data.id}" id="myLabel${data.id}">
                                <img class="box-images px-2 py-2" image_id="" src="<?php echo e(asset("file")); ?>/${data.name}" alt="..." >
                            </label>
                        </div>
                    </div>`;
...
<?php /**PATH /home/myazatrendz/public_html/resources/views/admin/mediascript/multiple_next.blade.php ENDPATH**/ ?>