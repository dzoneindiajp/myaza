          ...
          <div class="row">
            <div class="sidebar-section col-md-3 col-sm-12 col-12">              
              <ul class="sidebar-account-menu">
                ...
                <li class="active"><a href="<?php echo e(route('user.wishlist')); ?>"> <i class="far fa-heart"></i>My Wishlist</a></li>            
...
<?php /**PATH /home/myazatrendz/public_html/resources/views/store/wishlist/index.blade.php ENDPATH**/ ?>