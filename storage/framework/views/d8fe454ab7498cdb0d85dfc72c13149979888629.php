        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <a href="<?php echo e(url('backoffice/reports/products')); ?>" class="btn btn-danger clear_btn">Clear</a>
                </div>
            </div><br>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#cat_id').on('change',function(e) {
                ...
                if(parent_id){
                    $.ajax({
                        url:"<?php echo e(route('admin.category.subCategories')); ?>",
                        type:"POST",
                        data: {
                            parent_id: parent_id
                        },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\myaza\resources\views/admin/reports/products.blade.php ENDPATH**/ ?>