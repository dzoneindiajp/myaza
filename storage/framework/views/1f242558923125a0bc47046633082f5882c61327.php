    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                     <div class="row">
            <a class="col-md-4 grid-margin stretch-card" href="<?php echo e(url('backoffice/users')); ?>">
            ...
            <a class="col-md-4 grid-margin stretch-card" href="<?php echo e(url('backoffice/products')); ?>">
            ...
            <a class="col-md-4 grid-margin stretch-card" href="<?php echo e(url('backoffice/categories')); ?>">
            ...
            <a class="col-md-4 grid-margin stretch-card" href="<?php echo e(url('backoffice/orders')); ?>">
            ...
            <a class="col-md-4 grid-margin stretch-card" href="<?php echo e(url('backoffice/refunds')); ?>">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $rcancels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cancel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td>
                              <span class="badge badge-warning p-2"><?php echo e($cancel->users->name); ?></span>
                            </td>
                            <?php $count = 0; ?>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $rcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td>
                              <img src="<?php echo e(asset('file/')); ?>/<?php echo e($category->image); ?>" style="width : 120px;"/>
                            </td>
                            <td>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr>
                            <td>
                              <span class="badge badge-warning p-2"><?php echo e($user->name); ?></span>
                            </td>
                            
                            <td>
                              <span class="badge badge-success p-2"><?php echo e($payment->amount); ?></span>
                            </td>
                            <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myazatrendz/public_html/resources/views/dashboard.blade.php ENDPATH**/ ?>