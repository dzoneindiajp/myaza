                                        ...
                                        <div class="order-table-wrapper">
                                            <form class="" id="couponform" method="post">
                                                ...
                                                <div class="coupon">
                                                    ...
                                                    <input type="hidden" name="payment_input" id="payment_input_couponform">
                                                    <a href="javascript:void(0)"><small data-toggle="modal"
                                                            data-target="#couponcodeModal">Available
                                                            Coupons</small></a><br>
                                                    <?php if(!Auth::check()){ ?>
                                                    <small class="text-danger">If you have individual coupon than
                                                        please <a href="<?php echo e(url('login')); ?>">login</a> before
                                                        apply</small>
                                                    <?php } ?>
                                                </div>
                                            </form>
                                        ...
                                        <div class="login-social">
                                            ...
                                            <div class="social">
                                                <ul class="social-icon">
                                                    <li class="facebook"><a
                                                            href="<?php echo e(url('/redirect/facebook')); ?>"><i
                                                                class="fab fa-facebook-f"></i><span>Facebook</span></a>
                                                    </li>
                                                    <li class="google"><a
                                                            href="<?php echo e(url('/redirect/google')); ?>"><i
                                        ...
                                        <div class="shipping-address-items">
                                            <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div style="cursor:pointer"
                                                    ...
                                                    <p><?php echo e($address->name); ?><span
                                                            class="ml-3">+91-<?php echo e($address->mobile); ?></span>
                                                    </p>
                                                    <p><?php echo e($address->area); ?> <?php echo e($address->house); ?>
                                                                ...
                                                                <div class="shipping-fields-wrapper row">
                                                                    ...
                                                                    <div class="form-group col-sm-6 col-12"
                                                                        ...
                                                                        <input type="tel" class="input-text "
                                                                            name="mobile" id="add-mobile" placeholder=""
                                                                            value="">
                                                                    </div>
...
$(document).ready(function(){
    ...
    function getstates(v) {
        if (v > 0) {
            $('#cover-spin').show(0);
            $.get("<?php echo e(route('checkout.states')); ?>", {
                'id': v
            }, function(x) {
                $('#cover-spin').hide(0);
    ...
    function getcity(v) {
        if (v > 0) {
            $('#cover-spin').show(0);
            $.get("<?php echo e(route('checkout.city')); ?>", {
                'id': v
            }, function(x) {
                $('#cover-spin').hide(0);
                var bn = '<option value="">Select an option…</option>';
