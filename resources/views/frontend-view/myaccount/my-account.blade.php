                        ...
                        <div class="widget-shopping-cart-content">
                          <ul class="mini-cart">
                            <li class="mini-cart-item">
                              ...
                              <a href="product-detail.html"><img src="{{ asset('frontend-view/images/1.jpg') }}" alt="">Malti Cushion Cover Set of Two-Reversible </a>
                            ...
                            <li class="mini-cart-item">
                              ...
                              <a href="product-detail.html"><img src="{{ asset('frontend-view/images/2.jpg') }}" alt="">Malti Cushion Cover Set of Two -Reversible </a>
                              <span class="quantity">1 × <span class="mini-cart-price"><span class="price">₹4100.00</span> </span></span>
                            </li>
                          </ul>
                    ...
                    <div class="box-body">
                      <a href="my-orders.html">
                        <div class="account-box-image">
                          <img src="{{ asset('frontend-view/images/icon-order.png') }}" alt="">
                  ...
                  <div class="box-wrap box-radius box-border-bottom account-box">
                    <div class="box-body">
                      <a href="my-points.html">
                        <div class="account-box-image">
                          <img src="{{ asset('frontend-view/images/icon-reward-point.png') }}" alt="">
                  ...
                  <div class="box-wrap box-radius box-border-bottom account-box">
                    <div class="box-body">
                      <a href="my-profile.html">
                        <div class="account-box-image">
                          <img src="{{ asset('frontend-view/images/icon-profile.png') }}" alt="">
                        </div>
                        <h5>My Profile</h5>
                      </a>
                    </div>
                 ...
                 <div class="box-item col-lg-4 col-md-4 col-sm-6 col-6">
                  <div class="box-wrap box-radius box-border-bottom account-box">
                    <div class="box-body">
                      <a href="my-wishlist.html">
                        <div class="account-box-image">
                          <img src="{{ asset('frontend-view/images/icon-wishlist.png') }}" alt="">
                  ...
                  <div class="box-wrap box-radius box-border-bottom account-box">
                    <div class="box-body">
                      <a href="my-coupones.html">
                        <div class="account-box-image">
                          <img src="{{ asset('frontend-view/images/icon-cupon.png') }}" alt="">
                  ...
                  <div class="box-wrap box-radius box-border-bottom account-box">
                    <div class="box-body">
                      <a href="my-address.html">
                        <div class="account-box-image">
                          <img src="{{ asset('frontend-view/images/icon-address.png') }}" alt="">
