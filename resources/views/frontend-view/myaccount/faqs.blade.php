                        ...
                        <div class="widget-shopping-cart-content">
                          <ul class="mini-cart">
                            <li class="mini-cart-item">
                              ...
                              <a href="{{ url('product-detail') }}"><img src="{{ asset('frontend-view/images/1.jpg') }}" alt="">Malti Cushion Cover Set of Two-Reversible </a>
                            ...
                            <li class="mini-cart-item">
                              ...
                              <a href="{{ url('product-detail') }}"><img src="{{ asset('frontend-view/images/2.jpg') }}" alt="">Malti Cushion Cover Set of Two -Reversible </a>
                              <span class="quantity">1 × <span class="mini-cart-price"><span class="price">₹4100.00</span> </span></span>
                            </li>
                          </ul>
