        ...
        <div class="container">
          ...
          <div class="content-area about_center">
            ...
            <div class="row">
                ...
                <div class="col-md-6 count-box">
                    <div class="count-img"><img class="d-block img-fluid" src="{{ asset('frontend-view/images/about-img.jpg') }}" alt="">
                    </div>
                </div>
            </div>
            <hr/>
              ...
              <div class="testimonial-carousel">
                  ...
                  <div class="testimonial-wrap">
                    ...
                    <div class="testimonail-image-title">
                      <div class="testimonial-image">
                        <img src="{{ asset('frontend-view/images/testimonial-img-1.png') }}" alt="">
                      </div>
                ...
                <div class="testimonial-item">
                  <div class="testimonial-wrap">
                    ...
                    <div class="testimonail-image-title">
                      <div class="testimonial-image">
                        <img src="{{ asset('frontend-view/images/testimonial-img-2.jpg') }}" alt="">
                      </div>
                      <div class="testimonial-title-wrap">
                        <h4 class="testimonial-title"> - Mark Jecno</h4>
                        <p class="testimonial-meta">Designer</p>
