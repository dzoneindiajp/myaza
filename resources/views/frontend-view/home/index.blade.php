              ...
              <div class="product-column-item">
                <a href="#">
                  <div class="product-column-image">
                    <img src="{{ asset('frontend-view/images/adv1.jpg') }}" alt="">
                  </div>
                </a>
              </div>
            </div>
                  ...
                  <div class="products  product-carousel-3">
                      ...
                      <div class="product-wrap">
                          <div class="product-image">
                              <a class="pro-img" href="#">
                                  <img src="{{ asset('frontend-view/images/1.jpg') }}"  alt="">
                              </a>
                              <div class="product-label">
                                  <span class="new-title">New</span>
                    ...
                    <div class="product-item animate__animated animate__fadeInUp">
                      <div class="product-wrap">
                          <div class="product-image">
                              <a class="pro-img" href="#">
                                  <img src="{{ asset('frontend-view/images/2.jpg') }}"  alt="">
                              </a>
                              <div class="product-action">
                                  <a class="wishlist" href="javascript:void(0);" title="Wishlist" data-toggle="tooltip" data-placement="top" title="Wishlist">
                                      <i class="fa fa-heart"></i>
                    ...
                    <div class="product-item animate__animated animate__fadeInUp">
                      <div class="product-wrap">
                          <div class="product-image">
                              <a class="pro-img" href="#">
                                  <img src="{{ asset('frontend-view/images/3.jpg') }}"  alt="">
                              </a>
                              <div class="product-action">
                                  <a class="wishlist" href="javascript:void(0);" title="Wishlist" data-toggle="tooltip" data-placement="top" title="Wishlist">
                                      <i class="fa fa-heart"></i>
                    ...
                    <div class="product-item animate__animated animate__fadeInUp">
                      <div class="product-wrap">
                          <div class="product-image">
                              <a class="pro-img" href="#">
                                  <img src="{{ asset('frontend-view/images/4.jpg') }}"  alt="">
                              </a>
                              <div class="product-label">
                                  <span class="new-title">New</span>
                                  <span class="sale-title">-32%</span>
                    ...
                    <div class="product-item animate__animated animate__fadeInUp">
                      <div class="product-wrap">
                          <div class="product-image">
                              <a class="pro-img" href="#">
                                  <img src="{{ asset('frontend-view/images/5.jpg') }}"  alt="">
                              </a>
                              <div class="product-label">
                                  <span class="new-title">New</span>
                              </div>
                    ...
                    <div class="product-item animate__animated animate__fadeInUp">
                      <div class="product-wrap">
                          <div class="product-image">
                              <a class="pro-img" href="#">
                                  <img src="{{ asset('frontend-view/images/6.jpg') }}"  alt="">
                              </a>
                              <div class="product-label">
                                <span class="sale-title">-32%</span>
                              </div>
            ...
            <div class="testimonial-wrap">
              ...
              <div class="testimonail-image-title">
                <div class="testimonial-image">
                  <img src="{{ asset('file/'.$test->image) }}" alt="">
                </div>
