                ...
                <div class="card card-1">
                    <div class="card-header bg-white">
                        <div class="media flex-sm-row flex-column-reverse justify-content-between ">
                            ...
                            <div class="col-auto text-center my-auto pl-0 pt-sm-4"> <img class="img-fluid my-auto align-items-center mb-0 pt-3" src="{{ asset('file/'.$sizecount->logo) }}" width="115" height="115">
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 <?php echo ($ry>0)?'mt-2':''; ?>">
                                <div class="card card-2 ">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="sq align-self-center "> <img class="img-fluid my-auto align-self-center mr-2 mr-md-4 pl-0 p-0 m-0" src="{{ asset('file') }}/{{$it->images}}" width="75" height="205" /> </div>
                    ...
                    <div class="card-footer">
                        <div class="jumbotron-fluid">
                            <div class="row justify-content-between ">
                                <div class="col-sm-auto col-auto my-auto"><img class="img-fluid my-auto align-self-center" src="{{ asset('file/'.$sizecount->logo) }}" width="115" height="115"></div>
