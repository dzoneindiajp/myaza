                ...
                <div class="page-banner-wrap">
                    <div role="navigation" aria-label="Breadcrumbs" class="breadcrumbs">
                        <ul class="breadcrumb-items">
                            ...
                            <?php } ?>
                            <li class="breadcrumb-item trail-end"><span itemprop="name">{{ $info['name'] }}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="summary product-summary">
                                    <h1 class="product-single-title">{{ $info['name'] }}</h1>
                                                      ...
                                                      <ul class="shareDetail">
                                                          <li>
                                                              <a rel="nofollow" href="#" target="_blank ">
                                                                  <img src="{{ url('images/fb.png') }}; " alt="Facebook Icon">
                                                              </a>
                                                          </li>
                                                          <li>
                                                              <a rel="nofollow" href="#" target="_blank">
                            ...
                            <div class="product-item animate__animated animate__fadeInUp">
                                <div class="product-wrap">
                                    <div class="product-image">
                                        <a class="pro-img" href="{{ url('/') }}/{{ $trend['slug'] }}">
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a href="{{ url('/') }}/{{ $trend['slug'] }}" class="quick-view"
            ...
            if (v.images.length > 0) {
                ...
                $.each(v.images, function(p, val) {
                    ...
                    if (p == 0) {
                        ...
                        //defaut = "<img class='xzoom' id='xzoom-default' src='https://myazatrendz.com/frontend-view/images/kurti1.jpg' xoriginal='"+ '{{ asset('file') }}/'+val.file_name +"' />";
                        //mainimg +="<a href='"+ '{{ asset('file') }}/'+val.file_name +"'><img class='xzoom-gallery' width='80' src='"+ '{{ asset('file') }}/'+val.file_name +"'  xpreview='"+ '{{ asset('file') }}/'+val.file_name +"' title=''></a>";
                    }
