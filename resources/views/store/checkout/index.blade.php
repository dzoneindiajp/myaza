                              ...
                              <div class="login-social">
                                    ...
                                    <div class="social">
                                       <ul class="social-icon">
                                          <li class="facebook"><a  href="{{ url('/redirect/facebook') }}"><i class="fab fa-facebook-f"></i><span>Facebook</span></a></li>
                                          <li class="google"><a href="{{ url('/redirect/google') }}"><i class="fab fa-google"></i><span>Google</span></a></li>
                                       </ul>
                                    </div>
                              </div>
                           ...
                           <div class="shipping-address shipping-section">
                              ...
                              <div class="shipping-address-items">
                                 ...
                                 <div style="cursor:pointer" class="shipping-address-item <?php echo (count($addresses) ==1 )?'selected-item':''; ?> <?php echo ($address->by_default === 1)?'selected-item':'not-selected-item' ;?>" data-id="<?php echo ($address->id); ?>">
                                    <p>{{$address->name}}<span class="ml-3">+91-{{$address->mobile}}</span></p>
                                    <p>{{$address->area}} {{$address->house}} {{$address->landmark}}
                                       <?php
                                 ...
                                 <div class="checkout-cart-item">
                                    <div class="checkout-cart-wrap">
                                       ...
                                       <div class="checkout-cart-desc">
                                          ...
                                          <p class="checkout-cart-meta"><span>Product Code : {{$rt->attributes->sku_code}}</span></p>
                                          <p class="checkout-cart-quantity">1 × <span class="mini-cart-price">
                                             <span class="price">₹{{$rt->price}}</span></span>
                                          </p>
                                       </div>
                                    </div>
                                 </div>
