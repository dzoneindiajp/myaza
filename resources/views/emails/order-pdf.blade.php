...
<body>
  <div class="wrapper"
    ...
    <div class="header"
      ...
      <div class="logo" style="  float: left;"> <a style="text-decoration: none;;" href="#"> <img style=" max-width: 120px; height: auto;" src="{{asset('file')}}/{{$setting->logo}}" style=" max-height: 115px;">
        </a> </div>
...
<table style=" background-color: #fff;  border-collapse: collapse;  box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.08);  color: #333333;  font-size: 14px;  margin: auto;  padding: 5px;  text-decoration: none;  width: 100%; margin: 0 0 25px; ">
        ...
        <tbody>
            ...
            <tr>
                <td style="border: 1px solid #e0e0e0;  padding: 7px 10px;" style="height:60px;width:60px"><img style="width: 75px; max-width: 100%; height: auto;" src="{{asset('file/'.$item->attributes->image)}}"> </td>
